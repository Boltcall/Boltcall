...
const ROUTES = [
  ...
  { path: "/blog/does-response-time-affect-local-business-results",  priority: "0.8", changefreq: "monthly" },
  { path: "/blog/fastest-way-dentist-respond-missed-calls",          priority: "0.8", changefreq: "monthly" },
  { path: "/blog/why-local-businesses-lose-customers-slow-response", priority: "0.8", changefreq: "monthly" },
