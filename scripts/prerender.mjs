...
const ROUTES = [
  ...
  '/industries/hvac-answering-service',
  '/industries/plumbing-answering-service',
  '/industries/contractor-answering-service',
  '/industries/dentist-answering-service',
  '/industries/lawyer-answering-service',
  '/industries/medspa-answering-service',
  '/solar',
  ...
  '/blog/speed-to-lead-for-law-firms',
