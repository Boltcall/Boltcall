            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-2xl bg-slate-50 p-3">
                ...
                <p className="mt-2 text-[10px] leading-relaxed text-slate-600">
                  AI already replied. Next step is confirming the appointment window and routing
                  to the calendar.
                </p>
              </div>
              ...
              >
                <div
                  className={cn(
                    ...
                    call.outcome === "Live" ? "bg-emerald-500" : "bg-blue-500",
                  )}
                />
...
export default LegacyBentoCard;
