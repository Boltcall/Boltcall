    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          "border-[0.5px] border-zinc-200 bg-white text-zinc-950 shadow-[0_18px_38px_-24px_rgba(15,23,42,0.35)]",
          "transition-[color,box-shadow,transform] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
      ...
      >
        <motion.span
          ...
          aria-hidden
          className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full bg-zinc-950"
          initial={false}
          style={{
            height: coverSize,
            left: origin.x,
