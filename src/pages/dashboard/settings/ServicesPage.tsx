            ...
            <div key={row.id || `new-${i}`} className="flex items-center gap-3">
              ...
              <div className="relative w-32">
                <input
                  ...
                  placeholder="Minutes"
                  className="w-full px-3 py-2 border border-gray-300 dark:border-[#2a2a30] dark:bg-[#17171b] dark:text-white dark:placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                />
              </div>
              <button
                onClick={() => deleteRow(i)}
