...
const blogPosts: BlogPost[] = [
  ...
  {
    title: 'AI Receptionist for Roofers: How to Win <span className="text-blue-600">More Storm Leads</span>',
    slug: '/blog/ai-receptionist-for-roofers',
    excerpt: 'A buyer guide for roofing companies that need faster storm-call response, cleaner intake, and a faster path to booked inspections.',
    date: 'June 20, 2026',
    readTime: '8 min read',
    category: 'Roofing|AI Receptionist|Speed to Lead',
    image: '/images/blog/previews/blog-ai-receptionist-for-roofers.svg',
  },
  {
  ...
  {
    title: 'AI Receptionist for HVAC: How <span className="text-blue-600">Speed to Lead</span> Wins More Service Calls',
    slug: '/blog/ai-receptionist-for-hvac-speed-to-lead',
    excerpt: 'How HVAC companies use AI response and intake to answer faster, qualify urgent service calls, and book more jobs before homeowners keep shopping.',
    date: 'June 20, 2026',
    readTime: '8 min read',
    category: 'HVAC|AI Receptionist|Speed to Lead',
    image: '/images/blog/previews/blog-ai-receptionist-for-hvac-speed-to-lead.svg',
  },
  {
    title: 'How Fast Should a Contractor Respond to a New Lead?',
    slug: '/blog/how-fast-contractor-respond-new-lead',
    excerpt: 'A practical speed-to-lead benchmark for contractors who want to stop losing high-intent calls and forms before the team can even quote the work.',
    date: 'June 20, 2026',
    readTime: '8 min read',
    category: 'Contractors|Speed to Lead|How-to',
    image: '/images/blog/previews/blog-how-fast-contractor-respond-new-lead.svg',
  },
  {
