...
const moreFromBoltcall: { label: string; href: string; tagline: string }[] = [
  ...
  { label: 'The Vanishing Client Report', href: '/lead-magnet/vanishing-client-report', tagline: 'Where inbound leads go silent, and how to win them back.' },
  { label: 'Website Audit', href: '/website-audit', tagline: 'Score your site on speed, SEO and lead capture.' },
  ...
  { label: 'Missed call text-back for small business', href: '/blog/missed-call-text-back-small-business', tagline: 'Turn every missed call into a text conversation within seconds.' },
  { label: 'Commercial roofing lead response time', href: '/blog/commercial-roofing-lead-response-time', tagline: 'Why commercial roofing bids are won on response speed.' },
