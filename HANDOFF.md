...
- **Probe Retell API:** `curl -X POST -H "Authorization: Bearer $(netlify env:get RETELL_API_KEY --context production | tail -1)" -H "Content-Type: application/json" -d '{"limit":1,"filter_criteria":{"channel":{"type":"string","op":"eq","value":"voice"}}}' https://api.retellai.com/v2/list-agents`
