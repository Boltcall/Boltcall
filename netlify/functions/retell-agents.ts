    ...
    // Custom: check availability
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          timezone: { type: 'string', description: 'Confirmed IANA timezone of the appointment, for example America/Chicago' },
        },
    ...
    // Custom: book appointment
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          start: { type: 'string', description: 'Exact offered calendar slot as ISO 8601 with UTC offset, for example 2026-10-20T10:00:00-05:00. Never guess an offset.' },
          timezone: { type: 'string', description: 'Confirmed IANA timezone for the appointment, for example America/Chicago. Must agree with start, date and time.' },
        ...
        required: ['name', 'date', 'time', 'start', 'timezone'],
      },
      timeout_ms: 20000,
    },
