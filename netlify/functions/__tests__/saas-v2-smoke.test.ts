...
function resetMockState() {
    ...
    chats: [
      {
        ...
        status: 'active',
        source: 'website',
        chat_history: [{ sender: 'customer', content: 'Can you help?', timestamp: new Date('2026-01-01').toISOString() }],
        last_message: 'Can you help?',
        last_message_at: new Date('2026-01-01').toISOString(),
        last_activity_at: new Date('2026-01-01').toISOString(),
        message_count: 1,
        agent_id: null,
  ...
  mockState.tableSingle = {
    ...
    chats: mockState.tableData.chats[0],
    locations: mockState.tableData.locations[0],
  };
  mockState.fromCalls = [];
  mockState.eqCalls = [];
...
const endpoints: Array<{
  ...
  { name: 'saas-v2-lead-status-flow', importPath: '../saas-v2-lead-status-flow', method: 'GET' },
...
const workspaceScopedTablesByEndpoint: Record<string, string[]> = {
  ...
  'saas-v2-ask-ai': ['retell_calls', 'callbacks'],
  'saas-v2-help-ask': [
    'business_profiles',
    'agents',
    'phone_numbers',
  ...
  'saas-v2-lead-status-flow': ['leads'],
  'saas-v2-leads': ['business_profiles', 'leads'],
  'saas-v2-message-draft-reply': ['chats'],
  'saas-v2-message-thread': ['chats', 'leads'],
  'saas-v2-messages': ['chats'],
  'saas-v2-narrative-insights': ['daily_metrics', 'callbacks', 'call_logs'],
  'saas-v2-reviews': ['daily_metrics', 'call_logs'],
